...
namespace BookingHotel_Application.Model.Migrations
{
    ...
    [Migration("20240928025809_payment_db")]
            ...
            modelBuilder.Entity("BookingHotel_Application.Model.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            firstName = "Admin",
                            lastName = "User",
                            userId = "c7ff328c-efe3-41e0-976a-017a51865b73"
                        });
                });
            ...
            modelBuilder.Entity("BookingHotel_Application.Model.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 1,
                            Status = 1,
                            passwordHash = "$2a$11$hLYQ1ASvze0RuLjBSAaa0OgNXc1dIhqe0WU0HkuNjGQ2/rQVIeAf6",
            ...
            modelBuilder.Entity("BookingHotel_Application.Model.Models.Payment", b =>
                {
                    b.HasOne("BookingHotel_Application.Model.Models.Booking", "Booking")
                        .WithOne("Payment")
                        .HasForeignKey("BookingHotel_Application.Model.Models.Payment", "bookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
