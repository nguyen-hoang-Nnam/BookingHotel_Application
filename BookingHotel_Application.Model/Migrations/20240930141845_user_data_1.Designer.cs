...
namespace BookingHotel_Application.Model.Migrations
{
    ...
    [Migration("20240930141845_user_data_1")]
    partial class user_data_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookingHotel_Application.Model.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            firstName = "Admin",
                            lastName = "User",
                            userId = "b7d6463c-2886-4437-aa24-dcf9750e9042"
                        });
                });
            ...
            modelBuilder.Entity("BookingHotel_Application.Model.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            firstName = "Customer",
                            lastName = "User",
                            userId = "5cf37520-77f7-4169-916c-1513a0c298e9"
                        });
                });
            ...
            modelBuilder.Entity("BookingHotel_Application.Model.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            firstName = "Staff",
                            lastName = "User",
                            userId = "ebb8a3e0-7493-4367-9ad8-792c5722667c"
                        });
                });
            ...
            modelBuilder.Entity("BookingHotel_Application.Model.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 1,
                            Status = 1,
                            passwordHash = "$2a$11$UXJAxlypIo2CmsHCCuVa0OZMhmv9HoWEij56c/SBZL41Hg.skR2H6",
                        ...
                        new
                        {
                            ...
                            Role = 2,
                            Status = 1,
                            passwordHash = "$2a$11$jWVe5TspAAAsAjZvIfjoCOenC89kdpe2oLVSPbAwEokVGrGOTWeIW",
                            phoneNumber = "1234567890",
                            refreshToken = "",
                            userName = "staff"
                        },
                        new
                        {
                            ...
                            Role = 3,
                            Status = 1,
                            passwordHash = "$2a$11$MXj.9U2n76mtkzzNQBmBEu/oGOzBzqVwBt92c5ySGDnxza81YynHi",
                            phoneNumber = "1234567890",
                            refreshToken = "",
                            userName = "customer"
                        });
